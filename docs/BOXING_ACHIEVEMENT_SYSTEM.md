...
### Core Concepts
- **Boxing Round** = Focus session (work period)
...
- **First Bell** - Complete your first boxing round
- **Training Begins** - Complete 5 boxing rounds
- **Getting Stronger** - Complete 25 boxing rounds
- **Seasoned Fighter** - Complete 100 boxing rounds
- **Champion Material** - Complete 500 boxing rounds
...
interface AchievementRequirement {
  type: 'sessions_completed' | 'streak_length' | 'total_time' | 'daily_goal' | 'mood_tracking';
  value: number;
